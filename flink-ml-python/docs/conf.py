...
# project = u'Flink ML Python API'
project = u'PyFlink'
copyright = u''
author = u'Author'

version_file = os.path.join("..", 'pyflink/ml/version.py')
try:
...
latex_documents = [
    (master_doc, 'pyflink.tex', u'Flink ML Python Documentation',
     [author], 'manual'),
]
...
man_pages = [
    (master_doc, 'pyflink', u'Flink ML Python Documentation',
     [author], 1)
]
