...
public class SparseIntDoubleVectorTest {
    ...
    public void testUnsortedIndex() {
        ...
        assertEquals(4, vector.size());
        assertArrayEquals(new int[] {0, 2, 3}, vector.getIndices());
        ...
        assertArrayEquals(new int[] {0, 1, 2, 3, 4, 5, 6}, vector.getIndices());
        assertArrayEquals(
    ...
    public void testClone() {
        ...
        assertArrayEquals(clonedSparseVec.getIndices(), new int[] {0, 2});
        ...
        assertArrayEquals(sparseVec.getIndices(), new int[] {0, 2});
