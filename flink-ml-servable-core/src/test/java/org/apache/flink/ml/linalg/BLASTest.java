...
public class BLASTest {
    ...
    private static final DenseVector<Integer, Double, int[], double[]> inputDenseVec =
    ...
    public void testAxpy() {
        ...
        DenseVector<Integer, Double, int[], double[]> anotherDenseVec =
                Vectors.dense(1, 2, 3, 4, 5);
        BLAS.axpy(1, inputDenseVec, anotherDenseVec);
        double[] expectedResult = new double[] {2, 0, 6, 8, 0};
        assertArrayEquals(expectedResult, anotherDenseVec.getValues(), TOLERANCE);
    ...
    public void testAxpyK() {
        ...
        DenseVector<Integer, Double, int[], double[]> anotherDenseVec = Vectors.dense(1, 2, 3);
    ...
    public void testDot() {
        DenseVector<Integer, Double, int[], double[]> anotherDenseVec =
                Vectors.dense(1, 2, 3, 4, 5);
        SparseVector<Integer, Double, int[], double[]> sparseVector1 =
                Vectors.sparse(5, new int[] {1, 2, 4}, new double[] {1., 1., 4.});
        SparseVector<Integer, Double, int[], double[]> sparseVector2 =
    ...
    public void testNorm2() {
        ...
        SparseVector<Integer, Double, int[], double[]> sparseVector =
                Vectors.sparse(5, new int[] {0, 2, 4}, new double[] {1, 3, 5});
    ...
    public void testScal() {
        ...
        assertArrayEquals(expectedDenseResult, inputDenseVec.getValues(), TOLERANCE);

        SparseVector<Integer, Double, int[], double[]> inputSparseVector =
                Vectors.sparse(5, new int[] {0, 2, 4}, new double[] {1, 3, 5});
        ...
        assertArrayEquals(expectedSparseResult, inputSparseVector.getValues(), TOLERANCE);
        assertArrayEquals(expectedSparseIndices, inputSparseVector.getIndices());
    }

    @Test
    public void testGemv() {
        DenseVector<Integer, Double, int[], double[]> anotherDenseVec = Vectors.dense(1.0, 2.0);
    ...
    public void testHDot() {
        ...
        SparseVector<Integer, Double, int[], double[]> sparseVec1 =
                Vectors.sparse(5, new int[] {0, 2, 3}, new double[] {1, 3, 5});
        SparseVector<Integer, Double, int[], double[]> sparseVec2 =
                Vectors.sparse(5, new int[] {0, 1, 4}, new double[] {1, 3, 5});
        BLAS.hDot(sparseVec1, sparseVec2);
        assertEquals(5, sparseVec2.size());
        assertArrayEquals(new int[] {0, 1, 4}, sparseVec2.getIndices());
        assertArrayEquals(new double[] {1, 0, 0}, sparseVec2.getValues(), TOLERANCE);

        // Tests hDot(dense, dense).
        DenseVector<Integer, Double, int[], double[]> denseVec1 = Vectors.dense(1, 2, 3, 4, 5);
        DenseVector<Integer, Double, int[], double[]> denseVec2 = Vectors.dense(1, 2, 3, 4, 5);
        BLAS.hDot(denseVec1, denseVec2);
        double[] expectedResult = new double[] {1, 4, 9, 16, 25};
        assertArrayEquals(expectedResult, denseVec2.getValues(), TOLERANCE);

        // Tests hDot(sparse, dense).
        BLAS.hDot(sparseVec1, denseVec1);
        expectedResult = new double[] {1, 0, 9, 20, 0};
        assertArrayEquals(expectedResult, denseVec1.getValues(), TOLERANCE);

        // Tests hDot(dense, sparse).
        DenseVector<Integer, Double, int[], double[]> denseVec3 = Vectors.dense(1, 2, 3, 4, 5);
        BLAS.hDot(denseVec3, sparseVec1);
        assertEquals(5, sparseVec1.size());
        assertArrayEquals(new int[] {0, 2, 3}, sparseVec1.getIndices());
        assertArrayEquals(new double[] {1, 9, 20}, sparseVec1.getValues(), TOLERANCE);
    }
}
