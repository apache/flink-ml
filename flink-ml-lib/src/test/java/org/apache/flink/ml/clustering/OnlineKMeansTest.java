...
public class OnlineKMeansTest extends TestLogger {
    ...
    public void testInputTypeConversion() throws Exception {
        offlineTrainTable = TestUtils.convertDataTypesToSparseInt(offlineTrainTable);
        onlineTrainTable = TestUtils.convertDataTypesToSparseInt(onlineTrainTable);
        onlinePredictTable = TestUtils.convertDataTypesToSparseInt(onlinePredictTable);
