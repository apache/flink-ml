...
import static org.apache.flink.ml.iteration.operator.OperatorUtils.processOperatorOrUdfIfSatisfy;
...
public abstract class AbstractAllRoundWrapperOperator<T, S extends StreamOperator<T>>
    ...
    public AbstractAllRoundWrapperOperator(
        ...
        processOperatorOrUdfIfSatisfy(
                wrappedOperator,
                EpochWatermarkAware.class,
                epochWatermarkAware ->
                        epochWatermarkAware.setEpochWatermarkSupplier(epochWatermarkSupplier));
