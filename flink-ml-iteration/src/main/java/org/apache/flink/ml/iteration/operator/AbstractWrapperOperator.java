...
public abstract class AbstractWrapperOperator<T>
        implements StreamOperator<IterationRecord<T>>, ProgressTrackerListener, BoundedMultiInput {
    ...
    private static class EpochWatermarkSupplier implements Supplier<Integer> {

        Integer round;

        public void set(Integer round) {
            this.round = round;
        }
