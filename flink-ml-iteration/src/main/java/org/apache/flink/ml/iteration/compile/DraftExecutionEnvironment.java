...
public class DraftExecutionEnvironment extends StreamExecutionEnvironment {
    ...
    public DraftExecutionEnvironment(StreamExecutionEnvironment actualEnv) {
        super(
    ...
    public void copyToActualEnvironment(OperatorWrapper<?, ?> operatorWrapper) {
        for (Transformation<?> draftTransformation : transformations) {
            transform(draftTransformation, operatorWrapper);
        }
    }
    ...
    private <TF extends Transformation<?>> void transform(
            TF draftTransformation, OperatorWrapper<?, ?> operatorWrapper) {
        ...
        for (Transformation<?> draftInput : draftTransformation.getInputs()) {
            transform(draftInput, operatorWrapper);
        }
    ...
    @VisibleForTesting
    Map<Integer, Transformation<?>> getDraftToActualTransformations() {
        return draftToActualTransformations;
    }
