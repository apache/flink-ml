...
/**
 * The factory of {@link ProgressTracker}. It analyze the inputs of an operator and create the
 * corresponding progress tracker.
 */
public class ProgressTrackerFactory {
    ...
    public static ProgressTracker create(
        ...
        return new ProgressTracker(numberOfChannels, progressTrackerListener);
    }
}
