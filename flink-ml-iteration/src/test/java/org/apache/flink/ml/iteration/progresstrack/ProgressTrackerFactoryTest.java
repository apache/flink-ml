...
/** Test the {@link ProgressTracker} is created correctly according to the topology. */
public class ProgressTrackerFactoryTest {

    private static ProgressTracker lastProgressTracker;
    ...
    private static class OneInputProgressTrackingOperator extends AbstractStreamOperator<Integer>
        ...
        public void setup(
            ...
            lastProgressTracker =
                    ProgressTrackerFactory.create(config, containingTask, (ignored) -> {});
        }
