...
/** Tests the logic of {@link ProgressTracker}. */
public class ProgressTrackerTest {
    ...
    public void testEpochWatermarkAlignment() throws IOException {
        ...
        ProgressTracker progressTracker =
                new ProgressTracker(numberOfChannels, recordingProgressListener);
    ...
    private static class RecordingProgressListener implements ProgressTrackerListener {
