...
perl -pi -e "s/"${OLD_VERSION}"/"${NEW_VERSION}"/g" docs/config.toml
perl -pi -e "s/"${OLD_VERSION}"/"${NEW_VERSION}"/g" docs/content/docs/try-flink-ml/java/build-your-own-project.md
